...
_orbatBriefingContents =  format ["<font size='18'>Skrócony Spis Drużyn:</font><br/>"];
...
_orbatBriefingContents = _orbatBriefingContents + _summaryGroupListing + "</font><br/><font size='18'>Pełny Spis Drużyn:</font><br/>" + _fullGroupListing;
